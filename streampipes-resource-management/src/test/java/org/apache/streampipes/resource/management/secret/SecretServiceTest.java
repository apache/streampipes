...
class SecretServiceTest {
  ...
  void applyConfigTraversesRuntimeResolvableGroups() {
    ...
    var groupProperty = new RuntimeResolvableGroupStaticProperty("group", "Group", "", List.of());
    groupProperty.setStaticProperties(List.of(secretProperty));

    new SecretService(new TestSecretHandler()).applyConfig(List.of(groupProperty));
