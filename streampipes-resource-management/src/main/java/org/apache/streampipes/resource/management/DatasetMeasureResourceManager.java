...
public class DatasetMeasureResourceManager extends AbstractResourceManager<IDatasetMeasureStorage> {
  ...
  public DatasetMeasureResourceManager(IDatasetMeasureStorage datasetStorage,
  ...
  private boolean canReadMeasure(Authentication auth, DatasetMeasure measure) {
    return measure != null
