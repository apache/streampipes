...
public class CachedChartStorage
    extends AbstractCachedCrudStorage<DataExplorerWidgetModel, IChartStorage>
  ...
  CachedChartStorage(IChartStorage delegate,
    ...
    super(delegate, cacheManager, CACHE_NAME, objectMapper, DataExplorerWidgetModel.class);
  }
}
