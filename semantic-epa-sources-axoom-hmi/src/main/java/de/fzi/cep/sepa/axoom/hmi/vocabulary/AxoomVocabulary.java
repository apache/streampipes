package de.fzi.cep.sepa.axoom.hmi.vocabulary;
...
public class AxoomVocabulary {
  ...
  public static final String MachineId = PREFIX +"machineId";
  public static final String MilkIncluded = PREFIX +"milkIncluded";
  public static final String SugarIncluded = PREFIX +"sugarIncluded";
