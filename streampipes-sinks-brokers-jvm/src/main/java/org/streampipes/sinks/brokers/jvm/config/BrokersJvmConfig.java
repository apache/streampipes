...
package org.streampipes.sinks.brokers.jvm.config;


import org.streampipes.config.SpConfig;
import org.streampipes.container.model.PeConfig;

public enum BrokersJvmConfig implements PeConfig {
	INSTANCE;
	...
	private final static String service_id = "pe/org.streampipes.sinks.brokers.jvm";
	private final static String service_name = "Sinks Brokers JVM";
	private final static String service_container_name = "sinks-brokers-jvm";
