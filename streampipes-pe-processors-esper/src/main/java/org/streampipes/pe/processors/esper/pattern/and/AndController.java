...
public class AndController extends StandaloneEventProcessorDeclarer<AndParameters> {
	...
	public SepaDescription declareModel() {
		...
		OneOfStaticProperty timeWindowUnit = new OneOfStaticProperty("time-unit", "Time Unit", "Specifies a unit for the time window of the co-occurrence. ");
		...
		OneOfStaticProperty matchingOperator = new OneOfStaticProperty("matching-operator", "Time Unit", "Specifies a unit for the time window of the co-occurrence. ");
