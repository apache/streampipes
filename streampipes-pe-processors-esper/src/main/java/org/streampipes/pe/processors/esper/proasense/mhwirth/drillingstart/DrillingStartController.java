...
public class DrillingStartController extends StandaloneEventProcessorDeclarerSingleton<DrillingStartParameters> {
	...
	@Override
	public ConfiguredEventProcessor<DrillingStartParameters> onInvocation
	...
	public DataProcessorDescription declareModel() {
		...
		DataProcessorDescription desc = new DataProcessorDescription("drillingstart", "Driling Start", "Detects start of a drilling process");
