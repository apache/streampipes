...
public class DebsChallenge2Controller extends StandaloneEventProcessorDeclarerSingleton<DebsChallenge2Parameters> {
	...
	public SepaDescription declareModel() {
		...
		SepaDescription desc = new SepaDescription("debs_c2", "DEBS Challenge v2",
	...
	@Override
	public ConfiguredEventProcessor<DebsChallenge2Parameters, EventProcessor<DebsChallenge2Parameters>> onInvocation
					(SepaInvocation sepa) {
		...
		return new ConfiguredEventProcessor<>(staticParam, DebsChallenge2::new);
	}
}
