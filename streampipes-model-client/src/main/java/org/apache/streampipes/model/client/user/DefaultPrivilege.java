...
public enum DefaultPrivilege {
  // Pipelines
  PRIVILEGE_READ_PIPELINE(Constants.PRIVILEGE_READ_PIPELINE_VALUE), PRIVILEGE_WRITE_PIPELINE(
          Constants.PRIVILEGE_WRITE_PIPELINE_VALUE),

  // Adapters
  PRIVILEGE_READ_ADAPTER(Constants.PRIVILEGE_READ_ADAPTER_VALUE), PRIVILEGE_WRITE_ADAPTER(
          Constants.PRIVILEGE_WRITE_ADAPTER_VALUE),

  // Pipeline Elements
  PRIVILEGE_READ_PIPELINE_ELEMENT(Constants.PRIVILEGE_READ_PIPELINE_ELEMENT_VALUE), PRIVILEGE_WRITE_PIPELINE_ELEMENT(
          Constants.PRIVILEGE_WRITE_PIPELINE_ELEMENT_VALUE),

  // Dashboard
  PRIVILEGE_READ_DASHBOARD(Constants.PRIVILEGE_READ_DASHBOARD_VALUE), PRIVILEGE_WRITE_DASHBOARD(
          Constants.PRIVILEGE_WRITE_DASHBOARD_VALUE),

  // Dashboard widget
  PRIVILEGE_READ_DASHBOARD_WIDGET(Constants.PRIVILEGE_READ_DASHBOARD_WIDGET_VALUE), PRIVILEGE_WRITE_DASHBOARD_WIDGET(
          Constants.PRIVILEGE_WRITE_DASHBOARD_WIDGET_VALUE),

  // Data Explorer view
  PRIVILEGE_READ_DATA_EXPLORER_VIEW(
          Constants.PRIVILEGE_READ_DATA_EXPLORER_VIEW_VALUE), PRIVILEGE_WRITE_DATA_EXPLORER_VIEW(
                  Constants.PRIVILEGE_WRITE_DATA_EXPLORER_VIEW_VALUE),

  // Data Explorer widget
  PRIVILEGE_READ_DATA_EXPLORER_WIDGET(
          Constants.PRIVILEGE_READ_DATA_EXPLORER_WIDGET_VALUE), PRIVILEGE_WRITE_DATA_EXPLORER_WIDGET(
                  Constants.PRIVILEGE_WRITE_DATA_EXPLORER_WIDGET_VALUE),

  // Apps
  PRIVILEGE_READ_APPS(Constants.PRIVILEGE_READ_APPS_VALUE), PRIVILEGE_WRITE_APPS(Constants.PRIVILEGE_WRITE_APPS_VALUE),

  // NOTIFICATIONS
  PRIVILEGE_READ_NOTIFICATIONS(Constants.PRIVILEGE_READ_NOTIFICATIONS_VALUE),

  // FILES
  PRIVILEGE_READ_FILES(Constants.PRIVILEGE_READ_FILES_VALUE), PRIVILEGE_WRITE_FILES(
          Constants.PRIVILEGE_WRITE_FILES_VALUE),

  // ASSETS
  PRIVILEGE_READ_ASSETS(Constants.PRIVILEGE_READ_ASSETS_VALUE), PRIVILEGE_WRITE_ASSETS(
          Constants.PRIVILEGE_WRITE_ASSETS_VALUE),

  // GENERIC STORAGE
  PRIVILEGE_READ_GENERIC_STORAGE(Constants.PRIVILEGE_READ_GENERIC_STORAGE_VALUE), PRIVILEGE_WRITE_GENERIC_STORAGE(
          Constants.PRIVILEGE_WRITE_GENERIC_STORAGE_VALUE),

  // Label
  PRIVILEGE_READ_LABELS(Constants.PRIVILEGE_READ_LABELS_VALUE), PRIVILEGE_WRITE_LABELS(
          Constants.PRIVILEGE_WRITE_LABELS_VALUE);
