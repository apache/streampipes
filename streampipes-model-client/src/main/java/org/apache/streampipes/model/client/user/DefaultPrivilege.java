...
public enum DefaultPrivilege {
  ...
  public static final class Constants {
    ...
    public static final String PRIVILEGE_READ_DATASET_VALUE = "PRIVILEGE_READ_DATASET";
    public static final String PRIVILEGE_WRITE_DATASET_VALUE  = "PRIVILEGE_WRITE_DATASET";
