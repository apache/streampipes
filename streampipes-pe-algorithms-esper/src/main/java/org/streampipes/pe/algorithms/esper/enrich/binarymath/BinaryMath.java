package org.streampipes.pe.algorithms.esper.enrich.binarymath;

import com.espertech.esper.client.soda.*;
import org.streampipes.pe.algorithms.esper.EsperEventEngine;
import org.streampipes.pe.algorithms.esper.enrich.math.Operation;
...
public class BinaryMath extends EsperEventEngine<BinaryMathParameter> {
    ...
    private SelectClause makeSelectClause(BinaryMathParameter bindingParameters) {
        ...
        org.streampipes.pe.algorithms.esper.enrich.math.Math.mathExpression(selectedOperation, clause, left, right, asName);
