...
public class FieldConverterProgram extends FlinkDataProcessorRuntime<FieldConverterParameters>  {

  public FieldConverterProgram(FieldConverterParameters params) {
    super(params);
  }

  public FieldConverterProgram(FieldConverterParameters params, FlinkDeploymentConfig config) {
    super(params, config);
  }
