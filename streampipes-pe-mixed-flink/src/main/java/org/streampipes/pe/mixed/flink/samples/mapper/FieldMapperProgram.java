...
public class FieldMapperProgram extends FlinkDataProcessorRuntime<FieldMapperParameters> {

  public FieldMapperProgram(FieldMapperParameters params) {
    super(params);
  }

  public FieldMapperProgram(FieldMapperParameters params, FlinkDeploymentConfig config) {
    super(params, config);
  }
