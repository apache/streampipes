...
package org.streampipes.pe.mixed.flink.samples.elasticsearch.elastic5;

import static org.apache.flink.util.Preconditions.checkArgument;
import static org.apache.flink.util.Preconditions.checkNotNull;

import org.streampipes.pe.mixed.flink.samples.elasticsearch.elastic5.util.Flink13SerializationUtil;
...
public abstract class ElasticsearchSinkBase<T> extends RichSinkFunction<T> implements CheckpointedFunction {
	...
	public ElasticsearchSinkBase(
		...
		checkArgument(Flink13SerializationUtil.isSerializable(elasticsearchSinkFunction),
			"The implementation of the provided ElasticsearchSinkFunction is not serializable. " +
				"The object probably contains or references non-serializable fields.");

		checkArgument(Flink13SerializationUtil.isSerializable(failureHandler),
