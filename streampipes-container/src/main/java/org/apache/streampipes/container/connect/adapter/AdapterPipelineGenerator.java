...
import org.apache.streampipes.container.connect.adapter.preprocessing.elements.AddTimestampPipelineElement;
import org.apache.streampipes.container.connect.adapter.preprocessing.elements.AddValuePipelineElement;
import org.apache.streampipes.container.connect.adapter.preprocessing.elements.DebugAdapterSink;
import org.apache.streampipes.container.connect.adapter.preprocessing.elements.SendToBrokerAdapterSink;
import org.apache.streampipes.container.connect.adapter.preprocessing.elements.SendToJmsAdapterSink;
import org.apache.streampipes.container.connect.adapter.preprocessing.elements.SendToKafkaAdapterSink;
import org.apache.streampipes.container.connect.adapter.preprocessing.elements.SendToMqttAdapterSink;
import org.apache.streampipes.container.connect.adapter.preprocessing.elements.SendToNatsAdapterSink;
import org.apache.streampipes.container.connect.adapter.preprocessing.elements.TransformSchemaAdapterPipelineElement;
import org.apache.streampipes.container.connect.adapter.preprocessing.elements.TransformStreamAdapterElement;
import org.apache.streampipes.container.connect.adapter.preprocessing.elements.TransformValueAdapterPipelineElement;
import org.apache.streampipes.container.connect.adapter.preprocessing.transform.stream.DuplicateFilterPipelineElement;
