package de.fzi.cep.sepa.sources.samples.mhwirth.friction;

import de.fzi.cep.sepa.sources.samples.friction.FrictionEventTransformer;
import de.fzi.cep.sepa.sources.samples.friction.FrictionOutputEvent;
import de.fzi.cep.sepa.sources.samples.friction.FrictionRawEvent;
import de.fzi.cep.sepa.sources.samples.friction.FrictionValue;
