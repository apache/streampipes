...
public class TwitterGeoStream implements EventStreamDeclarer{
	...
	public EventStream declareModel(SepDescription sep) {
		...
		eventProperties.add(new EventPropertyPrimitive(XSD._double.toString(), "latitude", "", de.fzi.cep.sepa.commons.Utils.createURI(SO.Latitude)));
		eventProperties.add(new EventPropertyPrimitive(XSD._double.toString(), "longitude", "", de.fzi.cep.sepa.commons.Utils.createURI(SO.Longitude)));
		eventProperties.add(new EventPropertyPrimitive(XSD._string.toString(), "userName", "", de.fzi.cep.sepa.commons.Utils.createURI(FOAF.Name)));
