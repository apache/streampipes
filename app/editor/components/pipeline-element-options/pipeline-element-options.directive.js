        ...
        controller: function ($scope) {
            ...
            $scope.openHelpDialog = function () {
                $mdDialog.show({
                    ...
                    templateUrl: 'app/editor/components/pipeline-element-options/help-dialog.tmpl.html',
            ...
            $scope.openPossibleElementsDialog = function () {
                $mdDialog.show({
                    ...
                    templateUrl: 'app/editor/components/pipeline-element-options/possible-elements-dialog.tmpl.html',
                    parent: angular.element(document.body),
                    clickOutsideToClose: true,
                    scope: $scope,
                    preserveScope: true
