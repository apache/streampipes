...
public class TestCamelAzureConnectorsModuleExport extends CamelAzureConnectorsModuleExport {

  @Override
  protected KameletSinkFactory createSinkFactory(KameletTemplateProvider templateProvider) {
    return new TestAzureKameletSinkFactory(templateProvider, getAppIdPrefix(), getAssetRoot());
  }
}
