...
public class DurationOfStayController extends FlatEpDeclarer<DurationOfStayParameters>{
	...
	public SepaDescription declareModel() {
		...
		SepaDescription desc = new SepaDescription("sepa/durationofstay", "Duration of Stay", "Calculates the duration of stay of a location-based object within a specified radius around a specified point-based coordinate.");
