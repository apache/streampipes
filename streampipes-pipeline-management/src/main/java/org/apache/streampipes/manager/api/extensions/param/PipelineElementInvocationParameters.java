...
public class PipelineElementInvocationParameters implements ExtensionServiceOperationParameters {

  public final SpServiceUrlProvider provider;
  private final String appId;

  public PipelineElementInvocationParameters(SpServiceUrlProvider provider,
                                             String appId) {
  ...
  public ExtensionServiceOperationType getOperationType() {
    return ExtensionServiceOperationType.PIPELINE_ELEMENT_INVOCATION;
  }
}
