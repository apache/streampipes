...
public class AdapterStartParameters implements ExtensionServiceOperationParameters {

  @Override
  public String toUrl(String baseUrl) {
    return String.join("/", List.of(baseUrl, "api", "v1", "worker", "stream", "invoke"));
  }
  ...
  public ExtensionServiceOperationType getOperationType() {
    return ExtensionServiceOperationType.ADAPTER_STATE_CHANGE;
  }
}
