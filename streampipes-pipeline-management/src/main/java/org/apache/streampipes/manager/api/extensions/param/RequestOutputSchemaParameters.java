...
public class RequestOutputSchemaParameters implements ExtensionServiceOperationParameters {

  public final SpServiceUrlProvider provider;
  private final String appId;

  public RequestOutputSchemaParameters(SpServiceUrlProvider provider,
                                       String appId) {
  ...
  public String toUrl(String baseUrl) {
    return String.join("/", List.of(baseUrl, provider.getPrefix(), appId, "output"));
  }
  ...
  public ExtensionServiceOperationType getOperationType() {
    return ExtensionServiceOperationType.OUTPUT_SCHEMA;
  }
}
