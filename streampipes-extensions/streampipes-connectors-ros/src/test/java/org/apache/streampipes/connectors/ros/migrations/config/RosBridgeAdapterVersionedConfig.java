...
public class RosBridgeAdapterVersionedConfig {
  ...
  public static AdapterDescription getRosBridgeAdapterDescriptionV0() {
    return AdapterConfigurationBuilder.create(RosBridgeAdapter.ID, 0, RosBridgeAdapter::new).withLocales(Locales.EN)
            ...
            .requiredSingleValueSelectionFromContainer(Labels.withId(TOPIC_KEY),
                    Arrays.asList(ROS_HOST_KEY, ROS_PORT_KEY))
            .buildConfiguration().getAdapterDescription();
  }

  public static AdapterDescription getRosBridgeAdapterDescriptionV1() {
    return AdapterConfigurationBuilder.create(RosBridgeAdapter.ID, 1, RosBridgeAdapter::new).withLocales(Locales.EN)
            .withAssets(ExtensionAssetType.DOCUMENTATION, ExtensionAssetType.ICON)
            .withCategory(AdapterType.Manufacturing).requiredTextParameter(Labels.withId(ROS_HOST_KEY))
