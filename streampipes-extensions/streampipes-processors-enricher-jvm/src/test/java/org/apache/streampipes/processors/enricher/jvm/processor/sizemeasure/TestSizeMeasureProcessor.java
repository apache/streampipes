...
public class TestSizeMeasureProcessor {
  ...
  static Stream<Arguments> arguments() {
    return Stream.of(Arguments.of(BYTES_OPTION, inputEvent, 96.0),
            Arguments.of(KILO_BYTES_OPTION, inputEvent, 0.09375));
  }

  @ParameterizedTest
  @MethodSource("arguments")
  public void testStringToState(String sizeUnit, Map<String, Object> intpuEvent, double expectedventSize) {

    var inputEvents = List.of(intpuEvent);
    List<Map<String, Object>> outputEvents = List.of(Map.of(KEY, VALUE, EVENT_SIZE, expectedventSize));

    var configuration = TestConfiguration.builder().config(SIZE_UNIT, sizeUnit)
