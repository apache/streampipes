...
public class ReprojectionProcessor extends StreamPipesDataProcessor {
  ...
  public DataProcessorDescription declareModel() {
    return ProcessingElementBuilder.create("org.apache.streampipes.processors.geo.jvm.jts.processor.reprojection", 0)
            ...
            .requiredStream(StreamRequirementsBuilder.create()
                    ...
                    .build())
            .outputStrategy(OutputStrategies.keep()).requiredIntegerParameter(Labels.withId(TARGET_EPSG_KEY), 32632)
            .build();
  }
  ...
  public void onEvent(Event event, SpOutputCollector collector) throws SpRuntimeException {
    ...
    if (!reprojected.isEmpty()) {
      ...
      LOG.warn("An empty point geometry is created" + " due invalid input values. Check used epsg Code:" + targetEpsg);
    }
  }
