...
public record KameletMessageMapping(PayloadMode payloadMode,
                                    String bodyFieldSelector,
                                    List<KameletHeaderMapping> headerMappings,
                                    String transformStepsYaml) {

  public KameletMessageMapping {
