...
public class TestStringCounterProcessor {
  ...
  @ParameterizedTest
  @MethodSource("data")
  public void testStringCounter(String selectedFieldName, List<String> eventStrings,
                                Tuple3<String, String, Integer> expectedValue) {
    ...
    Tuple3<String, String, Integer> tuple = sendEvents(stringCounter, spOut, selectedFieldName, eventStrings);
  ...
  private List<Event> makeEvents(String selectedFieldName, List<String> eventStrings) {
    ...
    for (String eventSetting : eventStrings) {
      events.add(makeEvent(selectedFieldName, eventSetting));
    }
    return events;
  }

  private Event makeEvent(String selectedFieldName, String value) {
