...
public class TestStringTimerProcessor {
  ...
  @ParameterizedTest
  @MethodSource("data")
  public void testStringTimer(String selectedFieldName, String outputFrequency,
                              String outputUnit, List<String> eventStrings, String expectedValue) {
    ...
    Tuple2<String, Double> res = sendEvents(stringTimer, spOut, selectedFieldName, eventStrings);
  ...
  private Tuple2<String, Double> sendEvents(StringTimerProcessor stringTimer, SpOutputCollector spOut,
                                            String selectedFieldName, List<String> eventStrings) {
    String field = "";
    double timeDiff = 0.0;
    List<Event> events = makeEvents(selectedFieldName, eventStrings);
  ...
  private List<Event> makeEvents(String selectedFieldName, List<String> eventStrings) {
  ...
  private Event makeEvent(String value, String selectedFieldName) {
