...
public enum BooleanOperatorType {
  ...
  XOR("XOR", "Performs XOR between boolean operands"), OR("OR", "Performs OR between boolean operands"), AND("AND",
          "Performs AND between boolean operands"), NOT("NOT", "Performs NOT on boolean operand"), X_NOR("X-NOR",
                  "Performs X-NOR between boolean operands"), NOR("NOR", "Performs NOR between boolean operands");
