...
public class FieldMapperParameters extends EventProcessorBindingParams {
  ...
  public FieldMapperParameters(DataProcessorInvocation graph, List<String> replacePropertyNames, String newFieldName) {
    super(graph);
    this.replacePropertyNames = replacePropertyNames;
    this.newFieldName = newFieldName;
  }

  public List<String> getReplacePropertyNames() {
    return replacePropertyNames;
  }
