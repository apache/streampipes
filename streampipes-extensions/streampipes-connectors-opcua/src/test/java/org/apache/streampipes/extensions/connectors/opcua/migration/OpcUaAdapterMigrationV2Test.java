...
public class OpcUaAdapterMigrationV2Test {
  ...
  public void testOPCUAAdapterMigrationV2() {
    ...
    var adapterDescriptionV2 = migrationV2.migrate(adapterDescriptionV1, extractorMock).element();
  ...
  private URI getTypeOfPortProperty(AdapterDescription adapterDescriptionV2) {
    return migrationV2.extractPortProperty(adapterDescriptionV2).getRequiredDatatype();
  }
}