...
import org.apache.streampipes.extensions.connectors.opcua.alarms.OpcUaAlarmAdapter;
...
import org.apache.streampipes.extensions.connectors.opcua.migration.OpcUaAdapterMigrationV7;
...
public class OpcUaConnectorsModuleExport implements IExtensionModuleExport {
  ...
  public List<StreamPipesAdapter> adapters() {
    return List.of(
        ...
        new OpcUaAlarmAdapter(clientProvider)
    );
  }
