...
public class StatementUtils {
   ...
   *
   * @param p
   *          The needed info about the parameter (index and type)
   * @param value
   *          The value of the object, which should be filled in the
   * @param ps
   *          The prepared statement, which will be filled
   * @throws SpRuntimeException
   *           When the data type in {@code p} is unknown
   * @throws SQLException
   *           When the setters of the statement throw an exception (e.g. {@code setInt()})
   */
