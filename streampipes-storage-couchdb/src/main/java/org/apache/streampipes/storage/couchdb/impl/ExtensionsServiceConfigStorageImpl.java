...
public class ExtensionsServiceConfigStorageImpl extends AbstractDao<SpServiceConfiguration>
  ...
  @Override
  public SpServiceConfiguration getElementById(String id) {
    return findWithNullIfEmpty(id);
  }

  @Override
  public SpServiceConfiguration updateElement(SpServiceConfiguration element) {
    update(element);
    return getElementById(element.getServiceName());
  }

  @Override
  public void deleteElement(SpServiceConfiguration element) {
    delete(element.getServiceName());
  }
}
