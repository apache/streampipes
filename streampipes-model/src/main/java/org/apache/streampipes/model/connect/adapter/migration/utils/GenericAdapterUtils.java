...
public class GenericAdapterUtils {
  ...
  public static void applyFormat(String formatType, JsonObject formatConfig, FormatMigrator migrator) {

    formatConfig.get(MigrationHelpers.PROPERTIES).getAsJsonObject().get(DocumentKeys.ALTERNATIVES).getAsJsonArray()
            .forEach(el -> {
