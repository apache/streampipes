...
/**
 * Default service tags for StreamPipes services.
 * Provides predefined service tags for core system components.
 */
public class DefaultSpServiceTags {

    /**
     * Service tag for core system services.
     */
    public static final SpServiceTag CORE = SpServiceTag.create(SpServiceTagPrefix.SYSTEM, "core");

    /**
     * Service tag for pipeline element services.
     */
    public static final SpServiceTag PE = SpServiceTag.create(SpServiceTagPrefix.SYSTEM, "pe");

    /**
     * Service tag for connect worker services.
     */
