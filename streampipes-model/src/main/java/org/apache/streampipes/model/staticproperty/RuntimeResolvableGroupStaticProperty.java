...
public class RuntimeResolvableGroupStaticProperty extends StaticPropertyGroup {

  private List<String> dependsOn;

  public RuntimeResolvableGroupStaticProperty() {
  ...
  public RuntimeResolvableGroupStaticProperty(RuntimeResolvableGroupStaticProperty other) {
    super(other);
