...
public class MailUtils {
  ...
  public static String extractAppName() {
    try {
      return removeWhitespacesAtEnd(Resources.toString(Resources.getResource("appname.txt"), Charsets.UTF_8));
    } catch (IOException e) {
      return "Apache StreamPipes";
    }
  }

  public static String removeWhitespacesAtEnd(String str) {
