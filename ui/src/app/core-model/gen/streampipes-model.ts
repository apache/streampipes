...
/* eslint-disable */
// @ts-nocheck
// Generated using typescript-generator version 2.24.612 on 2020-10-02 09:31:34.
...
export class Category {
    ...
    static fromData(data: Category, target?: Category): Category {
        ...
        instance.name = data.name;
        instance.internalName = data.internalName;
        instance.superLabel = Label.fromData(data.superLabel);
        instance.labels = __getCopyArrayFn(Label.fromData)(data.labels);
