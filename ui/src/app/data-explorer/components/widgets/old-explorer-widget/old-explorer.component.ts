...
@Component({
    ...
    templateUrl: './old-explorer.component.html',
    styleUrls: ['./old-explorer.css'],
})
export class OldExplorerComponent implements OnInit {
    ...
    downloadDataAsFile() {
        const dialogRef = this.dialog.open(DataDownloadDialog, {
            ...
            data:
              { data: this.data,
                xAxesKey: this.xAxesKey,
                yAxesKeys: this.yAxesKeys,
                index: this.selectedInfoResult.measureName,
                date: this.dateRange},
