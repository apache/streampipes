        ...
        steps: [
            {
                ...
                text: "<p>In this tutorial, you'll learn how to create a live dashboard that shows data from a running pipeline.</p><b>Note:</b>This tutorial requires a running pipeline that makes use of the <i>Dashboard Sink</i>. If you don't have such a pipeline started yet, go to the pipeline editor and create one.<p>Press <i>Next</i> to start the tutorial!</p>",
                buttons: ['cancel', 'next'],
            },
            {
                stepId: 'step-2',
                title: 'Add visualization',
                text: "<p>Let's start!</p><p>To create a new visualization, click the <i>Add visualization</i> button.</p>",
            ...
            },
            {
                ...
                text: "<p>The second step requires the selection of a visualization. You can select from tables, gauges, maps or charts.</p><p>In this tutorial, we'll create a table visualization, so click the <i>Table</i> visualization on the left.</p>",
                attachToElement: 'md-grid-tile:nth-of-type(1)',
                attachPosition: 'right',
                buttons: ['cancel'],
            },
