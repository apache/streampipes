...
public class ContainerDeploymentStatus {
    ...
    private DockerConstants.ContainerStatus status;
    ...
    public ContainerDeploymentStatus(String containerId, DockerContainer container, long timestamp,
                                     DockerConstants.ContainerStatus status) {
    ...
    public DockerConstants.ContainerStatus getStatus() {
        return status;
    }

    public void setStatus(DockerConstants.ContainerStatus status) {
        this.status = status;
    }
}
