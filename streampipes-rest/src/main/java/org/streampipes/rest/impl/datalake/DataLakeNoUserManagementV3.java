...
public class DataLakeNoUserManagementV3 extends AbstractRestInterface {
    ...
    public void addDataLake(String measure, EventSchema eventSchema) {
        ...
        Optional optional = dataLakeMeasureList.stream().filter(entry -> entry.getMeasureName().equals(measure)).findFirst();
