...
package org.apache.streampipes.processors.transformation.jvm.config;


import org.apache.streampipes.config.SpConfig;
import org.apache.streampipes.container.model.PeConfig;

public enum TransformationJvmConfig implements PeConfig {
	INSTANCE;
	...
	private final static String service_id = "pe/org.apache.streampipes.processors.transformation.jvm";
	...
	static {
		serverUrl = TransformationJvmConfig.INSTANCE.getHost() + ":" + TransformationJvmConfig.INSTANCE.getPort();
		iconBaseUrl = "http://" + TransformationJvmConfig.INSTANCE.getIconHost() + ":" + TransformationJvmConfig.INSTANCE.getIconPort() +"/assets/img/pe_icons";
	}
