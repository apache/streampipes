...
public class StringTimekeeping implements EventProcessor<StringTimekeepingParameters> {
    ...
    @Override
    public void onInvocation(StringTimekeepingParameters booleanInverterParameters,
                             SpOutputCollector spOutputCollector,
                             EventProcessorRuntimeContext runtimeContext) {
        LOG = booleanInverterParameters.getGraph().getLogger(StringTimekeeping.class);
