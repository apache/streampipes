...
package org.apache.streampipes.processors.transformation.jvm.processor.stringoperator.timekeeping;
...
public class StringTimekeepingController extends StandaloneEventProcessingDeclarer<StringTimekeepingParameters> {
  ...
  public DataProcessorDescription declareModel() {
    return ProcessingElementBuilder.create("org.apache.streampipes.processors.transformation.jvm.stringoperator.timekeeping")
  ...
  @Override
  public ConfiguredEventProcessor<StringTimekeepingParameters> onInvocation(DataProcessorInvocation graph, ProcessingElementParameterExtractor extractor) {
    ...
    StringTimekeepingParameters params = new StringTimekeepingParameters(graph, leftFieldName, rightFieldName, outputDivisor);


    return new ConfiguredEventProcessor<>(params, StringTimekeeping::new);
  }
}
