...
public enum PeJvmConfig implements PeConfig {
	...
	PeJvmConfig() {
		...
		config.register(ConfigKeys.HOST, "pe-examples-jvm", "Hostname for the pe esper");
		...
		config.register(ConfigKeys.SERVICE_NAME, "Examples JVM", "The name of the service");

	}
	
	static {
		serverUrl = PeJvmConfig.INSTANCE.getHost() + ":" + PeJvmConfig.INSTANCE.getPort();
		iconBaseUrl = "http://" + PeJvmConfig.INSTANCE.getIconHost() + ":" + PeJvmConfig.INSTANCE.getIconPort() +"/assets/img/pe_icons";
	}
