...
public class StreamPipesCredentials {
   ...
   *
   * @param username
   *          The username of the authenticated user - note that this is currently the email address of the registered
   *          user!
   * @param apiKey
  ...
  public static CredentialsProvider withServiceToken(String username, String tokenSecret) {
