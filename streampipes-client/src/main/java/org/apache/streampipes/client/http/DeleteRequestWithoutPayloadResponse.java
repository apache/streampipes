...
public class DeleteRequestWithoutPayloadResponse<K, V> extends DeleteRequest<K, V, Void> {

  public DeleteRequestWithoutPayloadResponse(StreamPipesClientConfig clientConfig,
