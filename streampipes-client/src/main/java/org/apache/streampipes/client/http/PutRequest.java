...
public class PutRequest<T> extends HttpRequest<T, Void, Void> {
  ...
  public PutRequest(StreamPipesClientConfig clientConfig, StreamPipesApiPath apiPath,
          Serializer<T, Void, Void> serializer, T body) {
  ...
  protected Request makeRequest(Serializer<T, Void, Void> serializer) {
    Request request = Request.Put(makeUrl()).setHeaders(standardPostHeaders());
