...
public class AdapterConfigurationManager {
    ...
    private static String getStreamPipesClientConfigFilename() {
        return "streampipes-adapter-axoom.config";
    }
    ...
    private static void createDefaultConfig() {
        ...
        properties.put(StreamPipesConstants.kafkaHostKey, StreamPipesConstants.kafkaHostDefault);
        properties.put(StreamPipesConstants.kafkaPortKey, StreamPipesConstants.kafkaPortDefault);
