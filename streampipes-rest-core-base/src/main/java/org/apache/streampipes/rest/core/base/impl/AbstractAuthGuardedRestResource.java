...
public class AbstractAuthGuardedRestResource extends AbstractRestResource {
  ...
  private static final List<String> adminRoles = Arrays.asList(DefaultRole.Constants.ROLE_ADMIN_VALUE,
  ...
  protected boolean hasAnyAuthority(List<String> authorities) {
    return isAuthenticated() && SecurityContextHolder.getContext().getAuthentication().getAuthorities().stream()
