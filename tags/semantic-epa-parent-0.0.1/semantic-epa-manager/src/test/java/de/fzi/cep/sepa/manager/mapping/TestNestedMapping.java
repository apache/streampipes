...
public class TestNestedMapping {
	...
	{
		Pipeline pipeline = Utils.getGson().fromJson(FileUtils.readFileToString(new File("src/test/resources/TestNestedMatching.jsonld"), "UTF-8"), Pipeline.class);
