...
public class TestMappingBinaryTwoNodes2  {
	
	public static void main(String[] args) throws Exception
	{
		Pipeline pipeline = Utils.getGson().fromJson(FileUtils.readFileToString(new File("src/test/resources/TestMappingBinaryTwoNodes2.jsonld"), "UTF-8"), Pipeline.class);
