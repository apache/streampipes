...
/**
 * AdapterMetrics class manages monitoring metrics related to StreamPipes adapters.
 * It allows register and remove adapter instances as well as updating the values of metrics.
...
public AdapterMetrics() {
   ...
   *
   * @param adapterId   The unique identifier for the adapter
   ...
   * @param adapterId            The unique identifier for the adapter
   * @param adapterName          The name of the adapter
   * @param totalEventsPublished The total number of events published by the adapter
   * @throws NoSuchElementException If the adapter is not registered yet
   */
   ...
   * This results in no more metrics being published for this adapter.
   *
   * @param adapterId   The unique identifier for the adapter
   * @param adapterName The name of the adapter
   * @throws NoSuchElementException If the adapter is not found in the registry
   */
