...
public enum Envs {
  ...
  SP_PRIORITIZED_PROTOCOL("SP_PRIORITIZED_PROTOCOL", "nats"),
  ...
  SP_FUNCTION_STATE_ENDPOINTS_ENABLED("SP_FUNCTION_STATE_ENDPOINTS_ENABLED", "false"),
  ...
  // Audit Storage
  SP_AUDIT_INFLUX_ORG("SP_AUDIT_INFLUX_ORG", "sp"),
  SP_AUDIT_ENABLED("SP_AUDIT_ENABLED", "false"),
  SP_AUDIT_QUEUE_CAPACITY("SP_AUDIT_QUEUE_CAPACITY", "1024"),
  SP_AUDIT_SHUTDOWN_TIMEOUT_SECONDS("SP_AUDIT_SHUTDOWN_TIMEOUT_SECONDS", "10"),
  SP_AUDIT_STORAGE_PROVIDER("SP_AUDIT_STORAGE_PROVIDER", "influx"),
  SP_AUDIT_INFLUX_URL("SP_AUDIT_INFLUX_URL", ""),
  SP_AUDIT_INFLUX_DATABASE("SP_AUDIT_INFLUX_DATABASE", ""),
  SP_AUDIT_INFLUX_TOKEN("SP_AUDIT_INFLUX_TOKEN", ""),
  ...
  SP_NATS_TOKEN("SP_NATS_TOKEN", ""),

  SP_PULSAR_URL("SP_PULSAR_URL", "pulsar://localhost:6650"),
  SP_CORE_EXTENSION_TRANSPORT_MODE("SP_CORE_EXTENSION_TRANSPORT_MODE", "http"),
  SP_CORE_EXTENSIONS_TRANSPORT_MODE_TIMEOUT_SECONDS("SP_CORE_EXTENSIONS_TRANSPORT_MODE_TIMEOUT_SECONDS", "20"),
  ...
  SP_OVERLOADED_THRESHOLD_PERCENTAGE("SP_OVERLOADED_THRESHOLD_PERCENTAGE", "85"),
  SP_HISTORY_RESOURCE_PERCENTAGE("SP_HISTORY_RESOURCE_PERCENTAGE", "0.9"),
  SP_MSG_RATE_DIFFERENCE_MIGRATOR_THRESHOLD("SP_MSG_RATE_DIFFERENCE_MIGRATOR_THRESHOLD", "85"),
  ...
  SP_OPCUA_DISALLOW_INSECURE_ENDPOINTS("SP_OPCUA_DISALLOW_INSECURE_ENDPOINTS", "false"),
  ...
  SP_MSSQL_POLLING_MIN_INTERVAL_SECONDS("SP_MSSQL_POLLING_MIN_INTERVAL_SECONDS", "1"),
