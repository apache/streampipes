...
public class MapAreaController extends ActionController {
	...
	public SecDescription declareModel() {
		...
		stream1.setUri(Config.serverUrl +"/" +Utils.getRandomString());
		
		
		List<StaticProperty> staticProperties = new ArrayList<StaticProperty>();
		staticProperties.add(new MappingPropertyUnary(URI.create(e1.getElementName()), "latitudeNw","latitudeNw", "Select latitude property (NW)"));
		staticProperties.add(new MappingPropertyUnary(URI.create(e2.getElementName()), "longitudeNw",  "longitudeNw", "Select longitude property (NW)"));
		staticProperties.add(new MappingPropertyUnary(URI.create(e3.getElementName()), "latitudeSe","latitudeSe", "Select latitude property (SE)"));
		staticProperties.add(new MappingPropertyUnary(URI.create(e4.getElementName()), "longitudeSe","longitudeSe", "Select longitude property (SE)"));
		staticProperties.add(new MappingPropertyUnary(URI.create(e5.getElementName()), "label", "label", "Select Label"));
