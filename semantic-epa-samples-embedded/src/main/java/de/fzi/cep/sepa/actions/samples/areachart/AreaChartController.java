...
public class AreaChartController implements SemanticEventConsumerDeclarer {
	...
	public SecDescription declareModel() {
		...
		staticProperties.add(new MappingPropertyUnary(URI.create(e1.getElementName()), "key", "key", "Select key property"));
		staticProperties.add(new MappingPropertyUnary(URI.create(e2.getElementName()), "value", "value", "Select value property"));
