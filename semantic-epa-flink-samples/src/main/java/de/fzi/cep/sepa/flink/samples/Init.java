...
public class Init {
	...
	public static void main(String[] args) {
		ModelSubmitter.submitMixed(Arrays.asList(new WordCountController(), new ElasticSearchController(),
				new NumberClassificationController(), new TimestampController()), 8094);
