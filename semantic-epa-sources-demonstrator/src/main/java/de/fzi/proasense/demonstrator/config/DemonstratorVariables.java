...
public enum DemonstratorVariables {
    ...
    SIENENS_FLOWRATESENSOR1("flowrate1", "Flow Rate Sensor Siemens 1", "","de.fzi.proasense.demonstrator.siemens.flowrate.sensor1"),
    SIENENS_FLOWRATESENSOR2("flowrate2", "Flow Rate Sensor Siemens 2", "","de.fzi.proasense.demonstrator.siemens.flowrate.sensor2"),
    ...
    FESTO_FLOWRATE("flowrate", "Flow Rate Sensor Festo 1", "","de.fzi.proasense.demonstrator.festo.flowrate"),
