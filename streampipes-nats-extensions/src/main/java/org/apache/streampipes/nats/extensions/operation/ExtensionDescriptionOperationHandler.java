...
public class ExtensionDescriptionOperationHandler implements ExtensionBrokerOperationHandler {

  private static final String OPERATION = "EXTENSION_DESCRIPTION";
  private static final String TOPIC_OPERATION_SEGMENT = "extension-description";
  ...
  public ExtensionDescriptionOperationHandler(
  ...
  public ExtensionServiceBrokerResponseEnvelope handle(ExtensionServiceBrokerRequestEnvelope request,
    ...
    if (PROVIDER_ADAPTER.equals(provider)) {
      ...
      return ExtensionBrokerResponseFactory.badRequest(
          request.getRequestId(),
          "InvalidTopic",
          "Unsupported provider for extension description: " + provider
      );
    }
