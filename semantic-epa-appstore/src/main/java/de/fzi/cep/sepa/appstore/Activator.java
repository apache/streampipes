...
public class Activator implements BundleActivator{
            ...
            public Object addingService(ServiceReference serviceRef) {
                ...
                try {
                    ...
                    try {
                        ...
                        httpService.registerServlet("/appstore", new ServletContainer(), getJerseyServletParams(), null);
                    } finally {
    ...
    private void unregisterServlets() {
        if (this.httpService != null) {
            httpService.unregister("/appstore");
        }
    }
	
	 private Dictionary<String, String> getJerseyServletParams() {
	        Dictionary<String, String> jerseyServletParams = new Hashtable<>();
	        jerseyServletParams.put("javax.ws.rs.Application", AppstoreApplication.class.getName());
