...
public class SSN {
  ...
  public static final String RESOLUTION = NS + "Resolution";
  public static final String MEASUREMENT_PROPERTY = NS + "MeasurementProperty";
  public static final String MEASUREMENT_RANGE = NS + "MeasurementRange";
