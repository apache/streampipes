...
public class SO {
  ...
  public static List<String> getAll() {
    return Arrays.asList(GEO_JSON_LINE_STRING, GEO_JSON_POLYGON, GEO_JSON_MULTI_POINT, GEO_JSON_MULTI_LINE_STRING,
            GEO_JSON_MULTI_POLYGON, QUANTITATIVE_VALUE, PROPERTY_VALUE_SPECIFICATION, NUMBER, ORG_ENUMERATION, ALTITUDE,
            ACCEPTS_RESERVATIONS, ACCESS_CODE, ACCESSIBILITY_API, ACCESSIBILITY_CONTROL, ACCESSIBILITY_FEATURE,
            ACCESSIBILITY_HAZARD, ACTION, ORG_ACTIVE_INGREDIENT, ACTIVITY_DURATION, ACTIVITY_FREQUENCY, ADDITIONAL_NAME,
            ADDITIONAL_VARIABLE, ADDRESS_LOCALITY, ORG_ADDRESS_REGION, ADMINISTRATION_ROUTE, ALCOHOL_WARNING, ALGORITHM,
            ALIGNMENT_TYPE, ALTERNATE_NAME, ALTERNATIVE_HEADLINE, AMOUNT_OF_THIS_GOOD, ANSWER_COUNT,
            APPLICATION_CATEGORY, APPLICATION_SUB_CATEGORY, APPLICATION_SUITE, ARRIVAL_GATE, ARRIVAL_PLATFORM,
            ARRIVAL_TERMINAL, ORG_ARRIVAL_TIME, ARTICLE_BODY, ARTICLE_SECTION, ASPECT, ASSEMBLY, ASSEMBLY_VERSION,
            ASSOCIATED_PATHOPHYSIOLOGY, AUDIENCE_TYPE, AVAILABILITY_ENDS, AVAILABILITY_STARTS, AVAILABLE_FROM,
            AVAILABLE_THROUGH, AWARD, BACKGROUND, BASE_SALARY, BENEFITS, BEST_RATING, BILLING_INCREMENT,
            BIOMECHNICAL_CLASS, BIRTH_DATE, BITRATE, BOARDING_GROUP, BODY_LOCATION, BOOK_EDITION, BOOKING_TIME, BOOLEAN,
            BOX, BREADCRUMB, BREASTFEEDING_WARNING, BROWSER_REQUIREMENTS, BUS_NAME, BUS_NUMBER, CALORIES, CAPTION,
            CARBOHYDRATE_CONTENT, CARRIER_REQUIREMENTS, CHARACTER_NAME, CHECKIN_TIME, CHECKOUT_TIME, CHILD_MAX_AGE,
            CHILD_MIN_AGE, CHOLESTEROL_CONTENT, CIRCLE, CLINCAL_PHARMACOLOGY, CLIP_NUMBER, CLOSES, CODE_REPOSITORY,
            CODE_VALUE, CODING_SYSTEM, COLOR, COMMENT_COUNT, COMMENT_TEXT, COMMENT_TIME, CONFIRMATION_NUMBER,
            CONTACT_TYPE, CONTENT_RATING, CONTENT_SIZE, CONTENT_TYPE, CONTENT_URL, COOK_TIME, COOKING_METHOD,
            COPYRIGHT_YEAR, COST_CURRENCY, COST_ORIGIN, COST_PER_UNIT, COUNTRIES_NOT_SUPPORTED, COUNTRIES_SUPPORTED,
            CURRENCIES_ACCEPTED, DATE_CREATED, DATE_ISSUED, DATE_MODIFIED, DATE_POSTED, ORG_DATE_PUBLISHED, DATE_TIME,
            DATELINE, DEATH_DATE, DEPARTURE_GATE, DEPARTURE_PLATFORM, DEPARTURE_TERMINAL, DEPARTURE_TIME, DEPENDENCIES,
            DEVICE, DIET_FEATURES, DISCOUNT, DISCOUNT_CODE, DISCOUNT_CURRENCY, DISCUSSION_URL, DISSOLUTION_DATE,
            DISTANCE, DOOR_TIME, DOSAGE_FORM, DOSE_UNIT, DOSE_VALUE, DOWNLOAD_URL, DOWNVOTE_COUNT, DROPOFF_TIME,
            DRUG_UNIT, DUNS, DURATION, EDUCATION_REQUIREMENTS, EDUCATIONAL_FRAMEWORK, EDUCATIONAL_ROLE,
            ORG_EDUCATIONAL_USE, ELEVATION, EMAIL, EMBED_URL, EMPLOYMENT_TYPE, ENCODING_FORMAT, ENCODING_TYPE, END_DATE,
            END_TIME, ORG_EPIDEMIOLOGY, EPISODE_NUMBER, ESTIMATED_FLIGHT_DURATION, EVIDENCE_ORIGIN, ORG_EXERCISE_TYPE,
            EXIF_DATA, EXPECTED_ARRIVAL_FROM, EXPECTED_ARRIVAL_UNTIL, EXPECTED_PROGNOSIS, EXPERIENCE_REQUIREMENTS,
            EXPERT_CONSIDERATIONS, EXPIRES, FAMILY_NAME, FAT_CONTENT, FAX_NUMBER, FEATURE_LIST, FIBER_CONTENT,
            FILE_FORMAT, FILE_SIZE, FLIGHT_DISTANCE, FLIGHT_NUMBER, FOLLOWUP, FOOD_WARNING, FOUNDING_DATE, FREE,
            FREQUENCY, FROM_LOCATION, FUNCTION, FUNCTIONAL_CLASS, GENDER, GENRE, GIVEN_NAME, GLOBAL_LOCATION_NUMBER,
            GTIN_13, GTIN_14, GTIN_8, GUIDELINE_DATE, HAS_MAP, HEADLINE, HIGH_PRICE, HONORIFIC_PREFIX, HONORIFIC_SUFFIX,
            HOW_PERFORMED, HTTP_METHOD, IATA_CODE, ICAO_CODE, IMAGE, IN_LANGUAGE, INCENTIVES, INDUSTRY,
            INFECTIOUS_AGENT, INGREDIENTS, INSTALL_URL, INTENSITY, INTERACTION_COUNT, INTERACTIVITY_TYPE,
            IS_AVAILABLE_GENERICALLY, IS_BASED_ON_URL, IS_FAMILY_FRIENDLY, IS_GIFT, IS_PROPRIETARY, ISBN, ISIC_V_4,
            ISSN, ISSUE_NUMBER, ITEM_LIST_ELEMENT, ITEM_LIST_ORDER, JOB_TITLE, KEYWORDS, LABEL_DETAILS, LAST_REVIEWED,
            LATITUDE, LEARNING_RESOURCE_TYPE, LEGAL_NAME, LICENSE, LINE, LODGING_UNIT_DESCRIPTION, LOGO, LONGITUDE,
            LOW_PRICE, MAP, MAX_PRICE, MAX_VALUE, MEAL_SERVICE, MECHANISM_OF_ACTION, MEMBERSHIP_NUMBER,
            MEMORY_REQUIREMENTS, MENU, MIN_PRICE, MIN_VALUE, MODIFIED_TIME, MPN, MULTIPLE_VALUES, MUSCLE_ACTION, NAICS,
            NAMED_POSITION, NATURAL_PROGRESSION, NON_PROPRIETARY_NAME, NORMAL_RANGE, NUM_ADULTS, NUM_CHILDREN,
            NUM_TRACKS, NUMBER_OF_EPISODES, NUMBER_OF_PAGES, NUMBER_OF_SEASONS, OCCUPATIONAL_CATEGORY, OFFER_COUNT,
            OPENING_HOURS, OPENS, OPERATING_SYSTEM, ORDER_DATE, ORDER_NUMBER, OUTCOME, OVERDOSAGE, OVERVIEW, OWNED_FROM,
            OWNED_THROUGH, PAGE_END, ORG_PAGE_START, PAGINATION, PARTY_SIZE, PATHOPHYSIOLOGY, PAYMENT_ACCEPTED,
            PAYMENT_DUE, PAYMENT_METHOD_ID, PAYMENT_URL, PERMISSIONS, PHASE, PHYSIOLOGICAL_BENEFITS, PICKUP_TIME,
            PLAYER_TYPE, POLYGON, POPULATION, POSITION, POSSIBLE_COMPLICATION, POST_OFFICE_BOX_NUMBER, POST_OP,
            POSTAL_CODE, PRE_OP, PREGNANCY_WARNING, PREP_TIME, PREPARATION, PRESCRIBING_INFO, PREVIOUS_START_DATE,
            PRICE, PRICE_CURRENCY, PRICE_RANGE, PRICE_TYPE, PRICE_VALID_UNTIL, PRINT_COLUMN, PRINT_EDITION, PRINT_PAGE,
            PRINT_SECTION, PROCEDURE, PROCESSING_TIME, PROCESSOR_REQUIREMENTS, PRODUCT_ID, PROFICIENCY_LEVEL,
            PROGRAM_NAME, PROGRAMMING_MODEL, PROPRIETARY_NAME, PROTEIN_CONTENT, PUBLICATION_TYPE, PUBLISHING_PRINCIPLES,
            QUALIFICATIONS, QUESTION, RATING_COUNT, RATING_VALUE, READONLY_VALUE, RECIPE_CATEGORY, RECIPE_CUISINE,
            RECIPE_INSTRUCTIONS, RECIPE_YIELD, RECOMMENDATION_STRENGTH, RELATED_LINK, RELEASE_DATE, RELEASE_NOTES,
            REPETITIONS, REPLY_TO_URL, REPRESENTATIVE_OF_PAGE, REQUIRED_GENDER, REQUIRED_MAX_AGE, REQUIRED_MIN_AGE,
            REQUIREMENTS, REQUIRES_SUBSCRIPTION, RESERVATION_ID, RESPONSIBILITIES, REST_PERIODS, REVIEW_BODY,
            REVIEW_COUNT, RISKS, RUNTIME, SAFETY_CONSIDERATION, SALARY_CURRENCY, SAME_AS, SAMPLE_TYPE,
            SATURATED_FAT_CONTENT, SCHEDULED_TIME, SCREENSHOT, SEASON_NUMBER, SEAT_NUMBER, SEAT_ROW, SEAT_SECTION,
            SERIAL_NUMBER, SERVES_CUISINE, SERVICE_TYPE, SERVICE_URL, SERVING_SIZE, SIGNIFICANCE, SIGNIFICANT_LINK,
            SKILLS, SKU, SODIUM_CONTENT, SOFTWARE_VERSION, SPECIAL_COMMITMENTS, STAGE_AS_NUMBER, STATUS, START_DATE,
            START_TIME, STEP, STEP_VALUE, STORAGE_REQUIREMENTS, STREET_ADDRESS, STRENGTH_UNIT, STRENGTH_VALUE,
            STRUCTURAL_CLASS, SUB_STAGE_SUFFIX, SUBTYPE, SUGAR_CONTENT, SUGGESTED_GENDER, SUGGESTED_MAX_AGE,
            SUGGESTED_MIN_AGE, TARGET_DESCRIPTION, TARGET_NAME, TARGET_PLATFORM, TARGET_POPULATION, TARGET_URL, TAX_ID,
            TELEPHONE, TEMPORAL, TEXT, THUMBNAIL_URL, TICKER_SYMBOL, TICKET_NUMBER, TICKET_TOKEN, TIME_REQUIRED,
            TISSUE_SAMPLE, TITLE, TO_LOCATION, TOTAL_PRICE, TOTAL_TIME, TRACKING_NUMBER, TRACKING_URL, TRAIN_NAME,
            TRAIN_NUMBER, TRANS_FAT_CONTENT, TRANSCRIPT, TRANSMISSION_METHOD, TYPICAL_AGE_RANGE, UNIT_CODE,
            UNSATURATED_FAT_CONTENT, UPLOAD_DATE, UPVOTE_COUNT, URL_TEMPLATE, VALID_FOR, VALID_FROM, VALID_THROUGH,
            VALID_UNTIL, VALUE, VALUE_ADDED_TAX_INCLUDED, VALUE_MAX_LENGTH, VALUE_MIN_LENGTH, VALUE_NAME, VALUE_PATTERN,
            VALUE_REQUIRED, VAT_ID, VERSION, VIDEO_FRAME_SIZE, VIDEO_QUALITY, VOLUME_NUMBER, WARNING, WEB_CHECKIN_TIME,
            WORD_COUNT, WORK_HOURS, WORKLOAD, WORST_RATING);
  }
}
