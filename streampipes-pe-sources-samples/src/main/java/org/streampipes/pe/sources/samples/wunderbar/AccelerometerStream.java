...
public class AccelerometerStream extends AbstractWunderbarStream {
	...
	public SpDataStream declareModel(DataSourceDescription sep) {
		...
		properties.add(EpProperties.doubleEp(Labels.empty(), "x", "http://schema.org/accelerometerX"));
		properties.add(EpProperties.doubleEp(Labels.empty(), "y", "http://schema.org/accelerometerY"));
		properties.add(EpProperties.doubleEp(Labels.empty(), "z", "http://schema.org/accelerometerZ"));
