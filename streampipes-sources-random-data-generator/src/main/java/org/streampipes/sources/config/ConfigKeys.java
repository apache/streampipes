...
public final class ConfigKeys {
    ...
    final static String SIMULATION_DELAY_MS = "SP_SIMULATION_DELAY_MS";
    final static String SIMULATION_DELAY_NS = "SP_SIMULATION_DELAY_NS";
    final static String SIMULATION_MAX_EVENTS = "SP_SIMULATION_MAX_EVENTS";
    final static String SIMULATION_WAIT_EVERY = "SP_SIMULATION_WAIT_EVERY";
