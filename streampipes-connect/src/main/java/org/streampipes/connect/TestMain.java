...
//        post.setEntity(new StringEntity(jsonld));
    ...
    private static void startSenseMapAdapter() throws IOException {
        ...
        AdapterDescription adapterDescription = new OpenSenseMapAdapter().declareModel();

        // Set broker URL
        for (StaticProperty property: adapterDescription.getConfig()) {
            if (property.getInternalName().equals("sensortype")) {
