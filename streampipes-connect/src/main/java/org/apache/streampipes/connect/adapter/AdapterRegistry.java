...
import org.apache.streampipes.connect.adapter.format.csv.CsvFormat;
import org.apache.streampipes.connect.adapter.format.csv.CsvParser;
import org.apache.streampipes.connect.adapter.format.geojson.GeoJsonFormat;
import org.apache.streampipes.connect.adapter.format.geojson.GeoJsonParser;
import org.apache.streampipes.connect.adapter.format.image.ImageFormat;
import org.apache.streampipes.connect.adapter.format.image.ImageParser;
import org.apache.streampipes.connect.adapter.format.json.arraykey.JsonFormat;
import org.apache.streampipes.connect.adapter.format.json.arraykey.JsonParser;
import org.apache.streampipes.connect.adapter.format.json.arraynokey.JsonArrayFormat;
import org.apache.streampipes.connect.adapter.format.json.arraynokey.JsonArrayParser;
