...
public class KafkaToJmsBridge extends MultiBrokerBridge<KafkaTransportProtocol, JmsTransportProtocol> {

    public KafkaToJmsBridge(KafkaTransportProtocol sourceProtocol, JmsTransportProtocol targetProtocol,
                            String relayStrategy) {
        super(sourceProtocol, targetProtocol, relayStrategy, SpKafkaConsumer::new, ActiveMQPublisher::new,
