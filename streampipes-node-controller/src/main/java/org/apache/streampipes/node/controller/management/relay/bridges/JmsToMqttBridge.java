...
public class JmsToMqttBridge extends MultiBrokerBridge<JmsTransportProtocol, MqttTransportProtocol> {

    public JmsToMqttBridge(JmsTransportProtocol sourceProtocol, MqttTransportProtocol targetProtocol,
                           String relayStrategy) {
        super(sourceProtocol, targetProtocol, relayStrategy, ActiveMQConsumer::new, MqttPublisher::new,
