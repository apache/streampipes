...
public class WorkerGuessSchemaHandler implements IHandler<GuessSchema> {

    private final String username;
    private final AdapterDescription adapterDescription;

    public WorkerGuessSchemaHandler(String username, AdapterDescription adapterDescription) {
        this.username = username;
        this.adapterDescription = adapterDescription;
    }

    @Override
    public GuessSchema handle() {
        String url = ConnectEndpointUtils.generateGuessSchemaEndpoint(username, adapterDescription);
        return HttpUtils.post(url, adapterDescription, GuessSchema.class);
    }
}
