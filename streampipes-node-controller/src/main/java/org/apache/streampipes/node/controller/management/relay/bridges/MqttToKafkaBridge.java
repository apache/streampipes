...
public class MqttToKafkaBridge extends MultiBrokerBridge<MqttTransportProtocol, KafkaTransportProtocol> {

    public MqttToKafkaBridge(MqttTransportProtocol sourceProtocol, KafkaTransportProtocol targetProtocol,
                             String relayStrategy) {
        super(sourceProtocol, targetProtocol, relayStrategy, MqttConsumer::new, SpKafkaProducer::new,
