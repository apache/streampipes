...
public class MqttToJmsBridge extends MultiBrokerBridge<MqttTransportProtocol, JmsTransportProtocol> {

    public MqttToJmsBridge(MqttTransportProtocol sourceProtocol, JmsTransportProtocol targetProtocol,
                           String relayStrategy) {
        super(sourceProtocol, targetProtocol, relayStrategy, MqttConsumer::new, ActiveMQPublisher::new,
