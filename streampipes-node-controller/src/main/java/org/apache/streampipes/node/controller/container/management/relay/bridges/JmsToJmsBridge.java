...
public class JmsToJmsBridge extends MultiBrokerBridge<JmsTransportProtocol, JmsTransportProtocol> {

    public JmsToJmsBridge(JmsTransportProtocol sourceProtocol, JmsTransportProtocol targetProtocol,
                          String relayStrategy) {
        super(sourceProtocol, targetProtocol, relayStrategy, ActiveMQConsumer::new, ActiveMQPublisher::new,
