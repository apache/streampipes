...
public abstract class DatasetMetadataCounter implements IDatasetMetadataCounter {

  private static final Logger LOG = LoggerFactory.getLogger(DatasetMetadataCounter.class);
